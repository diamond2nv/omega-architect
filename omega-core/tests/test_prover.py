...
class TestProverIntegration:
    ...
    @pytest.mark.skip(reason="integration test requiring t2_real (lean-lsp-mcp)")
    def test_real_compile_trivial(self) -> None:
    ...
    @pytest.mark.skip(reason="integration test requiring t2_real (lean-lsp-mcp)")
    def test_real_compile_ensemble(self) -> None:
